<script>
    import { selectedPlanet1Id, selectedPlanet2Id, selectedPlanet1, selectedPlanet2 } from '$lib/stores/selectedPlanets';
...
<div class="container">
    ...
    <main>
        <div class="selectors">
            <PlanetSelector value={$selectedPlanet1Id} on:change={handlePlanet1Change} planetNumber={1} />
            <span class="vs">VS</span>
            <PlanetSelector value={$selectedPlanet2Id} on:change={handlePlanet2Change} planetNumber={2} />
        </div>
...
<style>
    ...
    :global(body) {
        ...
        margin: 0;
        font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; /* Более системный шрифт */
    }
</style>